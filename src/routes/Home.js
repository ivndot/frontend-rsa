    ...
    <div className="container">
      ...
      <section className="info">
        ...
        <p className="info__content">
          ...
          contenido de texto plano, o contenido sin cifrar, que se haya encriptado con la clave pública, podrá
          ser descifrado mediante la clave privada, y viceversa, todo contenido cifrado con la clave privada
          podrá ser descifrado mediante la clave pública.
        </p>
      </section>
